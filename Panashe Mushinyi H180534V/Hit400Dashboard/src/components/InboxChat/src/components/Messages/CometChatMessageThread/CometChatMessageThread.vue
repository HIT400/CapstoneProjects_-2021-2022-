<template>
    <div :style="styles.wrapper" class="cometchat__thread__wrapper">
        ...
        <div
            ...
            class="cometchat__thread__container"
        >
            <div :style="styles.parentMessage">
                <template v-if="loggedInUser.uid === parentMessage.sender.uid">
                    ...
                    <template
                        v-else-if="
                            parentMessage.type === ENUMS.CUSTOM_TYPE_POLL
                        "
                    >
                    ...
                    <template
                        v-else-if="
                            parentMessage.type === ENUMS.CUSTOM_TYPE_STICKER
                        "
                    >
...
import CometChatMessageList from '../CometChatMessageList/CometChatMessageList.vue'
import CometChatMessageComposer from '../CometChatMessageComposer/CometChatMessageComposer.vue'
...
export default {
    ...
    methods: {
        ...
        cometChatEventListeners() {
            CometChatEvent.on(
                enums.EVENTS['THREAD_MESSAGE_COMPOSED'],
                ({ messages }) => {
                    this.replyCount = this.replyCount + 1
                    this.appendMessage(messages)
            ...
            CometChatEvent.on(
                enums.EVENTS['THREAD_MESSAGE_SENT'],
                ({ messages }) => {
                    this.messageSent(messages)
                    CometChatEvent.triggerHandler(
                        enums.EVENTS['UPDATED_LAST_MESSAGES'],
                        { ...messages[0] }
                    )
                }
            )
            CometChatEvent.on(
                enums.EVENTS['ERROR_IN_SENDING_THREAD_MESSAGE'],
                ({ messages }) => {
                    this.messageSent(messages)
                }
            )
