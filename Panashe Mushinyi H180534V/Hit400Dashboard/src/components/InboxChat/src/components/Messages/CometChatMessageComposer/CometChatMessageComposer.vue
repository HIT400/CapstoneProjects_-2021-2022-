            ...
            <div tabIndex="-1" :style="styles.inputInner">
                ...
                <div :style="styles.inputSticky">
                    <div :style="styles.stickyAttachment">
                        <div
                            class="composer__attachment_icon"
                    ...
                    >
                        ...
                        >
                            <img
                                ...
                                :src="
                                    icons[
                                        showStickerPicker ? 'close' : 'sticker'
                                    ]
                                "
                            />
                        </div>
                        ...
                        >
                            <img
                                ...
                                :style="styles.composerIcon.img"
                                :src="
                                    icons[showEmojiPicker ? 'close' : 'emoji']
                                "
                            />
                        </div>
                        <div
...
import {
    getExtensionsDataFromMessage,
    getUnixTimestamp,
    ID,
} from '../../../util/common'

import CometChatCreatePoll from '../../Messages/Extensions/CometChatCreatePoll/CometChatCreatePoll.vue'
import CometChatSmartReplyPreview from '../CometChatSmartReplyPreview/CometChatSmartReplyPreview.vue'
import CometChatStickerKeyboard from '../CometChatStickerKeyboard/CometChatStickerKeyboard.vue'
...
export default {
    ...
    methods: {
        ...
        sendMessage() {
            ...
            const receiverType =
                this.type === CometChat.ACTION_TYPE.TYPE_USER
