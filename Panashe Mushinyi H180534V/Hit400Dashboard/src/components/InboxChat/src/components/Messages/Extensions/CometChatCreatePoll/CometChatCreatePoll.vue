        ...
        <div :style="styles.modalWrapper" class="modal__createpoll__wrapper">
            ...
            <div :style="styles.modalBody">
                <table
                    ...
                    class="modal__createpoll__table"
                >
...
import CometChatCreatePollOptions from '../CometChatCreatePollOptions/CometChatCreatePollOptions.vue'
    ...
    methods: {
        ...
        async createPoll() {
            ...
            try {
                ...
                this.error =
                    Object.prototype.toString.call(errorMessage) ===
                    '[object String]'
                        ? errorMessage
    ...
    beforeMount() {
        ;(async () => {
            try {
                ...
                console.error(
                    '[CometChatCreatePoll] getLoggedInUser error',
                    error
                )
            }
        })()
