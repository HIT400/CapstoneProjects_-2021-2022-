            ...
            <template v-for="(message, i) in computedMessages">
                ...
                <template v-else-if="message.category === 'custom'">
                    <template v-if="loggedInUser.uid === message.sender.uid">
                        ...
                        <template v-else>
                            <template
                                v-if="message.type === ENUMS.CUSTOM_TYPE_POLL"
                            >
                ...
                <template
                    v-else-if="
                        message.category === 'action' && canShowMessage(message)
                    "
                >
                    <div
...
import CometChatActionMessageBubble from '../CometChatActionMessageBubble/CometChatActionMessageBubble.vue'
import CometChatDeleteMessageBubble from '../CometChatDeleteMessageBubble/CometChatDeleteMessageBubble.vue'
import CometChatSenderTextMessageBubble from '../CometChatSenderTextMessageBubble/CometChatSenderTextMessageBubble.vue'
import CometChatSenderFileMessageBubble from '../CometChatSenderFileMessageBubble/CometChatSenderFileMessageBubble.vue'
import CometChatSenderImageMessageBubble from '../CometChatSenderImageMessageBubble/CometChatSenderImageMessageBubble.vue'
import CometChatSenderVideoMessageBubble from '../CometChatSenderVideoMessageBubble/CometChatSenderVideoMessageBubble.vue'
import CometChatSenderAudioMessageBubble from '../CometChatSenderAudioMessageBubble/CometChatSenderAudioMessageBubble.vue'
import CometChatReceiverTextMessageBubble from '../CometChatReceiverTextMessageBubble/CometChatReceiverTextMessageBubble.vue'
import CometChatReceiverFileMessageBubble from '../CometChatReceiverFileMessageBubble/CometChatReceiverFileMessageBubble.vue'
import CometChatReceiverImageMessageBubble from '../CometChatReceiverImageMessageBubble/CometChatReceiverImageMessageBubble.vue'
import CometChatReceiverVideoMessageBubble from '../CometChatReceiverVideoMessageBubble/CometChatReceiverVideoMessageBubble.vue'
import CometChatReceiverAudioMessageBubble from '../CometChatReceiverAudioMessageBubble/CometChatReceiverAudioMessageBubble.vue'
import CometChatSenderPollMessageBubble from '../Extensions/CometChatSenderPollMessageBubble/CometChatSenderPollMessageBubble.vue'
import CometChatReceiverPollMessageBubble from '../Extensions/CometChatReceiverPollMessageBubble/CometChatReceiverPollMessageBubble.vue'
import CometChatSenderStickerMessageBubble from '../Extensions/CometChatSenderStickerMessageBubble/CometChatSenderStickerMessageBubble.vue'
import CometChatReceiverStickerMessageBubble from '../Extensions/CometChatReceiverStickerMessageBubble/CometChatReceiverStickerMessageBubble.vue'
...
export default {
    ...
    methods: {
        ...
        scrollHandler(e) {
            this.$nextTick(() => {
                try {
                    ...
                    const scrollHeight = this.$refs.messagesEnd
                        ? this.$refs.messagesEnd.scrollHeight
                        : 0
                    const clientHeight = this.$refs.messagesEnd
                        ? this.$refs.messagesEnd.clientHeight
                        : 0
                    ...
                    if (
                        ...
                        CometChatEvent.triggerHandler(
                            enums.EVENTS['CLEAR_UNREAD_MESSAGES'],
                            {}
                        )
                    }
        ...
        customMessageReceived(message) {
            if (
                ...
                if (this.hasProperty(message, 'metadata')) {
                    ...
                    this.emitAction('customMessageReceived', {
                        messages: [message],
                    })
            ...
            if (!message.parentMessageId) {
                ...
                if (
                    ...
                    if (this.messages.length > enums.MAX_MESSAGE_COUNT) {
                        ...
                        this.emitAction('messageReceived', {
                            messages: [message],
                        })
                    }
                } else {
        ...
        reInitializeMessageBuilder() {
            ...
            CometChatEvent.triggerHandler(enums.EVENTS['REFRESHING_MESSAGES'], {
                messages: [],
            })
            ...
            if (
                ...
                if (message.getReceiptType() === 'delivery') {
                    ...
                    if (msg) {
                        ...
                        this.emitAction('messageUpdated', {
        ...
        async getMessages(scrollListToBottom = false, refresh = false) {
            ...
            try {
                ...
                const messages =
                    await this.messageListManager.fetchPreviousMessages()

                if (messages.length === 0) {
                    this.decoratorMessage =
                        COMETCHAT_CONSTANTS.NO_MESSAGES_FOUND
                } else {
                    this.decoratorMessage = ''
                }
        ...
        attachMessageListeners() {
            if (this.messageListManager) {
                this.messageListManager.attachListeners(
