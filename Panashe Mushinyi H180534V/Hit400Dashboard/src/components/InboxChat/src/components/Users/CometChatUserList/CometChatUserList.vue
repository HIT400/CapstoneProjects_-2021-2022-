...
import CometChatUserListItem from '../CometChatUserListItem/CometChatUserListItem.vue'
    ...
    computed: {
        ...
        styles() {
            return {
                ...
                headerTitle: style.contactHeaderTitleStyle(
                    this.enableCloseMenu
                ),
                searchInput: style.contactSearchInputStyle(
                    this.themeValue,
                    searchIcon
                ),
            }
