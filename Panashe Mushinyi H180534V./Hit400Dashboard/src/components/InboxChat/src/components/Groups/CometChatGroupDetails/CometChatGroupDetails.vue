...
import CometChatViewGroupMemberList from '../CometChatViewGroupMemberList/CometChatViewGroupMemberList.vue'
import CometChatAddGroupMemberList from '../CometChatAddGroupMemberList/CometChatAddGroupMemberList.vue'
import CometChatBanGroupMemberList from '../CometChatBanGroupMemberList/CometChatBanGroupMemberList.vue'
...
export default {
    ...
    methods: {
        ...
        groupUpdateHandler(key, message, group, options) {
            ...
            const isActionFromHere =
                message.actionBy.uid === this.loggedInUser.uid
        ...
        groupMemberUpdated(member) {
            try {
                ...
                if (bannedMemberKey > -1) {
                    ...
                    let newBannedMemberObj = Object.assign(
                        {},
                        bannedMemberObj,
                        member
                    )
                    bannedmemberlist.splice(
                        bannedMemberKey,
                        1,
                        newBannedMemberObj
                    )
        ...
        updateParticipants(updatedMember, message) {
            try {
                ...
                if (memberKey > -1) {
                    ...
                    const newMemberObj = Object.assign(
                        {},
                        memberObj,
                        updatedMember,
                        {
        ...
        async getGroupMembers() {
            try {
                ...
                const groupMembers =
                    await groupDetailManager.fetchNextGroupMembers()
                ...
                groupMembers.forEach((member) => {
                    ...
                    if (
                        member.scope === CometChat.GROUP_MEMBER_SCOPE.MODERATOR
                    ) {
        ...
        async getBannedGroupMembers() {
            ...
            try {
                ...
                const bannedMembers =
                    await groupDetailManager.fetchNextBannedGroupMembers()
    ...
    beforeMount() {
        ...
        ;(async () => {
            try {
                ...
                this.logError(
                    '[CometChatGroupDetails] getLoggedInUser error',
                    error
                )
            }
        })()
