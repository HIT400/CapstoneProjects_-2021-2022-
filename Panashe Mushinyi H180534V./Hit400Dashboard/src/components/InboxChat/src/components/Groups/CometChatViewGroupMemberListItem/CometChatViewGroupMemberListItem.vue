    ...
    <tr :style="styles.tableRow">
        ...
        <td class="member__list__scope__column">
            <div :style="styles.scopeWrapper">
                <template v-if="showChangeScope && canChangeScope">
                    ...
                    >
                        <option
                            :value="COMET_CHAT.GROUP_MEMBER_SCOPE.PARTICIPANT"
                        >
                            {{
                        ...
                        <option
                            :value="COMET_CHAT.GROUP_MEMBER_SCOPE.MODERATOR"
                        >
        ...
        <template v-if="canEdit">
            <td
                ...
                class="member__list__action__column"
            >
                <span>
                    <img
                        :src="icons.ban"
            ...
            >
                <span>
                    <img
                        ...
                        v-if="canViewAction"
                        :style="{
                            ...styles.actionColumn.img,
                            ...styles.actionColumn.kick,
                        }"
