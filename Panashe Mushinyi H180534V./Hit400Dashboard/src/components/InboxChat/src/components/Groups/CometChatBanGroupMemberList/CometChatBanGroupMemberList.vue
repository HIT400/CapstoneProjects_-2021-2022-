...
import CometChatBanGroupMemberListItem from '../CometChatBanGroupMemberListItem/CometChatBanGroupMemberListItem.vue'
    ...
    methods: {
        ...
        async unbanMember(memberToUnBan) {
            try {
                ...
                if (response) {
                    this.emitAction('unbanGroupMembers', {
                        members: [memberToUnBan],
                    })
                }
            } catch (error) {
