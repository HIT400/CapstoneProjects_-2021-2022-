<template>
    <div :style="styles.wrapper" class="groups__wrapper">
        <div :style="styles.header">
            ...
            />
            <h4 :style="styles.headerTitle">Groups</h4>
            <div
                :style="styles.add"
                v-if="canCreateGroup"
...
import CometChatCreateGroup from '../CometChatCreateGroup/CometChatCreateGroup.vue'
import CometChatGroupListItem from '../CometChatGroupListItem/CometChatGroupListItem.vue'
    ...
    computed: {
        ...
        styles() {
            return {
                ...
                searchInput: style.groupSearchInputStyle(
                    this.themeValue,
                    searchIcon
                ),
            }
        ...
        propsForWatcher: {
            handler(_, prevProps) {
                ...
                if (
                    ...
                    if (groupKey > -1) {
                        const groupObj = groups[groupKey]
                        const newGroupObj = Object.assign(
                            {},
                            groupObj,
                            groupToUpdate,
                            {
                    ...
                    try {
                        ...
                        if (groupKey > -1) {
                            ...
                            const newGroupObj = Object.assign(
                                ...
                                response,
                                {
                                    scope: CometChat.GROUP_MEMBER_SCOPE
                                        .PARTICIPANT,
                                }
                            )
        ...
        updateMemberAdded(group, options) {
            try {
                ...
                if (groupKey > -1) {
                    ...
                    let scope = this.hasProperty(group, 'scope')
                        ? group.scope
                        : ''
                    ...
                    let scope = this.hasProperty(groupObj, 'scope')
                        ? groupObj.scope
                        : {}
        ...
        onSearchChange(event) {
            try {
                ...
                if (
                    ...
                    COMETCHAT_CONSTANTS.EMPTY_STRING
                ) {
                    this.searchStarted = setTimeout(() => {
                        this.decoratorMessage =
                            COMETCHAT_CONSTANTS.SEARCH_LOADING
