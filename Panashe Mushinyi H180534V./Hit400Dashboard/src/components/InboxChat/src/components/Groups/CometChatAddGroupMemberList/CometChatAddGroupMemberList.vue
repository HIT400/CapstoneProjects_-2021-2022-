<template>
    <div>
        ...
        <div
            ...
            class="cometchat__add__members__wrapper"
        >
            <span
                title="Close"
                    ...
                    <tfoot>
                        <tr :style="styles.tableFoot.tr">
                            <td colSpan="2" :style="styles.tableFoot.td">
                                <button
                                    :style="styles.tableFoot.button"
                                    @click="updateMembers"
                                >
                                    {{
                                        membersAdding
                                            ? STRINGS.ADDING_MESSSAGE
                                            : STRINGS.ADD
                                    }}
                                </button>
                            </td>
...
import CometChatAddGroupMemberListItem from '../CometChatAddGroupMemberListItem/CometChatAddGroupMemberListItem.vue'
            ...
            try {
                ...
                if (filteredUserList.length === 0) {
                    this.decoratorMessage =
                        COMETCHAT_CONSTANTS.ERROR_NO_USERS_FOUND
                }
            ...
            try {
                ...
                if (membersList.length) {
                    ...
                    try {
                        ...
                        this.logError(
                            'addMembersToGroup failed with exception:',
                            error
                        )
                    } finally {
