						...
						<div class="example">
							...
							<div class="row" style="padding: 0px;">
								...
								<div class="col-md-2 text-left " style="margin-top:36px">
									<a <?php
										echo ('href="add-to-watch.php?id=' . $org['id'] . '"')
										...
										?> class="btn btn-primary mr-2
										 <?php
											...
											if (in_array($_GET['id'], $watchlist)) {
												echo ("disabled");
											}
											?>" style="color:white;background:green;width:150px;padding:16px;font-weight:750">Watch</a>
								</div>
								<div class="col-md-2 text-left " style="margin-top:36px">
									<a <?php
										$myStocks = explode("/", $user['stocks']);
										array_shift($myStocks);
										$myStocks = array_unique($myStocks);
										$stockAction="Buy";
										if (in_array($_GET['id'], $myStocks)) {
											echo ('href="sell-stock.php?id=' . $_GET['id'] . '"');
											$stockAction = "Sell";
										} else {
											echo ('href="buy-stock.php?id=' . $_GET['id'] . '"');
										}


										?> class="btn btn-primary mr-2" style="color:white;background:green;width:150px;padding:16px;font-weight:750"><?= $stockAction?></a>
								</div>
