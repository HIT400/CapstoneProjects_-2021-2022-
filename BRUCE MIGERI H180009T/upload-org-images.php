...
if (!empty($_FILES)) {
	...
	updateOrgImagesById($_SESSION["org_id"], $uploadedFile);
...
<body>
			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-md-8 offset-md-1 stretch-card grid-margin grid-margin-md-0">
						<div class="card">
							<div class="card-body">
								<h6 class="card-title"> Upload company images/gallery</h6>
								<br>
								...
								');
									...
									echo (' <a href="upload-org-docs.php" class="btn btn-primary mr-2" style="color:black;background:gold;width:150px">Next</a>
								');
								}
	...
	<script type="text/javascript">
		Dropzone.options.exampleDropzone = {
			maxFilesize: 10,
			acceptedFiles: ".png,.jpg,.jpeg,.bmp,.gif,.zip"
		};
	</script>
