...
$org= getOrgByEmail($_SESSION["email"]);
                                    ...
                                    <table id="dataTableExample" class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="color:#335D2D;font-weight:750">Share holders</th>
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $watch_url  = "org-home-view.php?id=" . $org['id'];
                                                $owners_url  = "org-owners.php?id=" . $org['id'];
                                                echo ('<tr>');
                                                echo ('<td>' . $org['org_name'] . '</td>');
                                                echo ('<td>US$ ' . $org['total_shares'] * $org['share_value'] . '</td>');
                                                echo ('<td>' . $org['shares_on_sale'] . '</td>');
                                                echo ('<td>US$' . $org['share_value'] . '</td>');
                                                echo ('<td><a target="blank"  href="' . $owners_url . '" class=" mr-2" style="color:darkgreen;"><i data-feather="user"></i></a></td>');
