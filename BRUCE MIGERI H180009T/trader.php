                    ...
                    <div class="col-md-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h6 class="card-title">Share Value</h6>
                                    </div>
...
foreach ($orgs as $org) {
    ...
    array_push($labels,$org['org_name']);
    array_push($share_value, $org['share_value']);
...
?>
    ...
    const myChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: 'share price',
                data: <?php echo json_encode($share_value); ?>,
                backgroundColor: [
                    'rgba(255, 99, 132, 0.2)',
                    'rgba(54, 162, 235, 0.2)',
                    'rgba(255, 206, 86, 0.2)',
