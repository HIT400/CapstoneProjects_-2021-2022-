...
if (isset($_POST['submit'])) {
  ...
  if (!userIsRegistered($email)) {
    ...
    if ($result) {
      ...
      $_SESSION["auth-acc-type"] = $accType;
          ...
          <div class="col-md-8 col-xl-6 mx-auto">
            <div class="card" style="background: rgba(255, 255, 255, 0.9);">
              <div class="row" style="padding:15px">
                ...
                <div class="col-md-12 pl-md-0 " style="padding: 15px;margin-top:-60px">
                  <div class="auth-form-wrapper px-4 py-5">
                    ...
                    <h5 class="font-weight-normal mb-4 text-center" style="color:#000;margin-top:30px;opacity:1"><?= $message ?></h5>
